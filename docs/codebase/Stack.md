...
| `lint` | `eslint src --max-warnings=160 --report-unused-disable-directives` | the warning budget is a ratchet — new code must not add warnings, and the number comes down when warnings are removed |
